...
map.getView().fit([-1144088.588082, 7143039.446233, -1089372.566428, 7177231.570088], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Beaches in Mayo</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (39 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Map of all the <br />Beaches in County <br />Mayo';
            }
