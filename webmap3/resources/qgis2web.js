...
map.getView().fit([-1357338.129669, 6720316.859370, -218817.057040, 7431780.382297], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Irish Towns</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (31 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Towns in Ireland <br />James Treanor';
            }
