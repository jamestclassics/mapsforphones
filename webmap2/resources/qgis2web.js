...
map.getView().fit([-1078009.779422, 6490124.723824, 428115.358608, 7431304.577613], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Service Stations England</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (44 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'map of all <br />the Service Stations <br />in England';
            }
