...
map.getView().fit([-709072.448305, 7042719.869406, -683625.696897, 7058621.582460], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Dublin Colleges</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (27 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'map of <br />Colleges <br />In Dublin';
            }
